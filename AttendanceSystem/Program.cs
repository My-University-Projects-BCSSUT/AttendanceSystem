...
using AttendanceSystem.Patterns.Factory;
...
builder.Services.AddScoped<IAttendanceSessionBuilder, AttendanceSessionBuilder>();
builder.Services.AddScoped<ICourseBuilder, CourseBuilder>();
